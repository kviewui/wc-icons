     ...
     * @description camera-filled 图标组件
     * @file icon-camera-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-camera-filled',
        shadow: true,
    })
    export class IconCameraFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
