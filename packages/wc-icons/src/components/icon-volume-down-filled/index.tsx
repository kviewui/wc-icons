     ...
     * @description volume-down-filled 图标组件
     * @file icon-volume-down-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-volume-down-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconVolumeDownFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
