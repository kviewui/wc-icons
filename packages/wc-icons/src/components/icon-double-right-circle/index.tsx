     ...
     * @description double-right-circle 图标组件
     * @file icon-double-right-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-double-right-circle',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconDoubleRightCircle {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
