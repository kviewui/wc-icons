     ...
     * @description left-circle 图标组件
     * @file icon-left-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-left-circle',
        shadow: true,
    })
    export class IconLeftCircle {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
