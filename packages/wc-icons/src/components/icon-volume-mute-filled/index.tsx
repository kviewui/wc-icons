     ...
     * @description volume-mute-filled 图标组件
     * @file icon-volume-mute-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-volume-mute-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconVolumeMuteFilled {
