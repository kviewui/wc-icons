     ...
     * @description double-down-circle 图标组件
     * @file icon-double-down-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-double-down-circle',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconDoubleDownCircle {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
