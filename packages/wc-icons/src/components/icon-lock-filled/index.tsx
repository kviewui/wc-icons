     ...
     * @description lock-filled 图标组件
     * @file icon-lock-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-lock-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconLockFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
