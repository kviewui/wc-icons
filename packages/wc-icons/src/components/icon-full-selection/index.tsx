     ...
     * @description full-selection 图标组件
     * @file icon-full-selection.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-full-selection',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconFullSelection {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
