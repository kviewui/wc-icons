     ...
     * @description map-draw-filled 图标组件
     * @file icon-map-draw-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-map-draw-filled',
        shadow: true,
    })
    export class IconMapDrawFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
