     ...
     * @description settings-filled 图标组件
     * @file icon-settings-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-settings-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconSettingsFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
