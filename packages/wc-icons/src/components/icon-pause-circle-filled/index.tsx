     ...
     * @description pause-circle-filled 图标组件
     * @file icon-pause-circle-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-pause-circle-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconPauseCircleFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
