     ...
     * @description double-left-circle 图标组件
     * @file icon-double-left-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-double-left-circle',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconDoubleLeftCircle {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
