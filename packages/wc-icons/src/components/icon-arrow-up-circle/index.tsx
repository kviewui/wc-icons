     ...
     * @description arrow-up-circle 图标组件
     * @file icon-arrow-up-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-arrow-up-circle',
        shadow: true,
    })
