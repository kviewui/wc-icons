     ...
     * @description more-app-filled 图标组件
     * @file icon-more-app-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-more-app-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconMoreAppFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
