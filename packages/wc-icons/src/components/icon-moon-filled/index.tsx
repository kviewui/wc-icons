     ...
     * @description moon-filled 图标组件
     * @file icon-moon-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-moon-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconMoonFilled {
