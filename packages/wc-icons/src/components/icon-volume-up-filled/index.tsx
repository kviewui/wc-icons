     ...
     * @description volume-up-filled 图标组件
     * @file icon-volume-up-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-volume-up-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconVolumeUpFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
