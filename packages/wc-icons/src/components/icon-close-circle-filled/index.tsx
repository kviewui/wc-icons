     ...
     * @description close-circle-filled 图标组件
     * @file icon-close-circle-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-close-circle-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconCloseCircleFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
