     ...
     * @description protect-filled 图标组件
     * @file icon-protect-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-protect-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconProtectFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
