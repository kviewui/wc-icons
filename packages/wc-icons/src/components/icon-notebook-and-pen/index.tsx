     ...
     * @description notebook-and-pen 图标组件
     * @file icon-notebook-and-pen.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-notebook-and-pen',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconNotebookAndPen {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
        ...
        render() {
            return (<Fragment>
                <svg width={this.size} height={this.size} viewBox="0 0 48 48" style={this.getStyle()} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 6v36h26V6H4Zm8 36V6m32 0h-8v32l4 4 4-4V6Zm-8 6h8M30 6H4m26 36H4M36 6v16m8-16v16" fill={this.fill} stroke={this.color} stroke-width={this.strokeWidth} stroke-linejoin={this.strokeLinejoin} stroke-linecap={this.strokeLinecap} fill-opacity="0.9"></path>
                </svg>
            </Fragment>);
        }
    }
