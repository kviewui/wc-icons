     ...
     * @description right-circle 图标组件
     * @file icon-right-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-right-circle',
        shadow: true,
    })
    export class IconRightCircle {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
