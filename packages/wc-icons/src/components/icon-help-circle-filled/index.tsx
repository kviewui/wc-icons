     ...
     * @description help-circle-filled 图标组件
     * @file icon-help-circle-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-help-circle-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconHelpCircleFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
