     ...
     * @description double-up-circle 图标组件
     * @file icon-double-up-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-double-up-circle',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconDoubleUpCircle {
