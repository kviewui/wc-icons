     ...
     * @description twitter-filled 图标组件
     * @file icon-twitter-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-twitter-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconTwitterFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
