     ...
     * @description like-filled 图标组件
     * @file icon-like-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-like-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconLikeFilled {
