     ...
     * @description forbid-filled 图标组件
     * @file icon-forbid-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-forbid-filled',
        shadow: true,
    })
    export class IconForbidFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
