     ...
     * @description mp-weixin-circle-filled 图标组件
     * @file icon-mp-weixin-circle-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-mp-weixin-circle-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconMpWeixinCircleFilled {
