     ...
     * @description down-circle 图标组件
     * @file icon-down-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-down-circle',
        shadow: true,
    })
    export class IconDownCircle {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
