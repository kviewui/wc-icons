     ...
     * @description alphabetical-sorting-desc 图标组件
     * @file icon-alphabetical-sorting-desc.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-alphabetical-sorting-desc',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconAlphabeticalSortingDesc {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
        ...
        render() {
            return (<Fragment>
                <svg width={this.size} height={this.size} viewBox="0 0 48 48" style={this.getStyle()} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M36 4v39.5M7 4h16L7 20h16M7 44l8.276-16L23 44m21-8-8 8-8-8" fill={this.fill} stroke={this.color} stroke-width={this.strokeWidth} stroke-linejoin={this.strokeLinejoin} stroke-linecap={this.strokeLinecap} fill-opacity="0.9"></path>
                </svg>
            </Fragment>);
        }
    }
