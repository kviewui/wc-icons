     ...
     * @description arrow-left-circle 图标组件
     * @file icon-arrow-left-circle.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-arrow-left-circle',
        shadow: true,
    })
