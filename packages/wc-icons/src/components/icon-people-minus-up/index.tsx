     ...
     * @description people-minus-up 图标组件
     * @file icon-people-minus-up.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-people-minus-up',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconPeopleMinusUp {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
