     ...
     * @description alphabetical-sorting-asc 图标组件
     * @file icon-alphabetical-sorting-asc.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-alphabetical-sorting-asc',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconAlphabeticalSortingAsc {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
        ...
        render() {
            return (<Fragment>
                <svg width={this.size} height={this.size} viewBox="0 0 48 48" style={this.getStyle()} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M36 4v39.5M7 28h16L7 44h16M7 20l8.276-16L23 20m21 16-8 8-8-8" fill={this.fill} stroke={this.color} stroke-width={this.strokeWidth} stroke-linejoin={this.strokeLinejoin} stroke-linecap={this.strokeLinecap} fill-opacity="0.9"></path>
                </svg>
            </Fragment>);
        }
    }
