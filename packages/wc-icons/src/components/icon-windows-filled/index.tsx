     ...
     * @description windows-filled 图标组件
     * @file icon-windows-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-windows-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconWindowsFilled {
