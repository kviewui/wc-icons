     ...
     * @description shopping-cart-add-filled 图标组件
     * @file icon-shopping-cart-add-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-shopping-cart-add-filled',
        shadow: true,
    })
    export class IconShoppingCartAddFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 24;
