     ...
     * @description intersection 图标组件
     * @file icon-intersection.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-intersection',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconIntersection {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
