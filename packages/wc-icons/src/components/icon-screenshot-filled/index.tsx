     ...
     * @description screenshot-filled 图标组件
     * @file icon-screenshot-filled.tsx
     * @auther kviewui
     */
    import { Component, h, Fragment, Prop } from '@stencil/core';

    @Component({
        tag: 'icon-screenshot-filled',
        shadow: true,
        styleUrl: '../../styles/index.css'
    })
    export class IconScreenshotFilled {
        /**
         * 图标大小
         */
        @Prop() size: number = 16;
